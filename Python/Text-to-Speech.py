# Run following commands in terminal for installing all the required libraries
...
root = Tk()  # to initialized tkinter which will be used for GUI
root.geometry('350x300')  # used to set the width and height of the window
root.resizable(0,0) 
root.config(bg='ghost white')  # used to access window attributes
root.title('TEXT_TO_SPEECH APP')  # set the title of the window
